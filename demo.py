...
parser.add_argument('--maxIter', metavar='T', default=150, type=int, help='number of maximum iterations')
parser.add_argument('--minLabels', metavar='minL', default=4, type=int,  help='minimum number of labels')
parser.add_argument('--lr', metavar='LR', default=0.05, type=float, help='learning rate')
...
parser.add_argument('--input', metavar='FILENAME', default='images/beam.png', help='input image file name')
